const peliculasSimilares = [
  {
    ...
    descripcion:
      "El mecánico Lino es un apasionado de los autos de combate, pero cuando se enfrenta a policías corruptos, éstos le ofrecen un trato que no puede rechazar.",
  ...
  },
  {
    ...
    descripcion:
      "Un escuadrón de élite cae en una emboscada a manos de un enemigo implacable y se ve obligado a defenderse con sus dos únicas armas: el ingenio y un fuerte espíritu de camaradería.",
  ...
  },
  {
    ...
    descripcion:
      "Una infame pandilla de ladrones motociclistas recluta al hermano de una excampeona de motocross para un robo, por lo que ahora ella debe enfrentar sus mayores miedos para protegerlo de las calles de París.",
  ...
  },
  {
    ...
    descripcion:
      "Mike, un trabajador de la construcción con los pies en la tierra, se ve inmerso en el mundo de los superespías y los agentes secretos cuando Roxanne, su novia del instituto, le recluta para una misión de los servicios de inteligencia estadounidenses.",
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  pelicula =
    peliculasSimilares.find((a) => a.titulo == titulo) ?? peliculasSimilares[0];
  addDefault(pelicula);
  addVideo(pelicula.video);
  addImage(pelicula.titulo);
  addActors(pelicula.actores);
